...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
			...
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:460,width:650,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}} className={"border border-dark  text-white"}>
						...
						<Card.Body>
							  <Form.Row>
							  	<Form.Group as={Col} controlId="formGridTitle">
							  	  <Form.Label style={{color:"black",marginLeft:56}}>Account Number</Form.Label>
							  	  <Form.Control required
							  	  	type="number" name="accNo"
							  	  	value={this.state.accNo}
							  	  	onChange={this.depositChange}
							  	  	className={"bg-dark text-white"}
							  	  	placeholder="Enter Account Number" />
							  	  <Form.Label style={{color:"black",marginLeft:96}}>Amount</Form.Label>
							  	  <Form.Control required
