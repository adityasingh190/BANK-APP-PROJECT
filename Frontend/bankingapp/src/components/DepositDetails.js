...
export default class DepositDetails extends Component {
	...
	componentDidMount(){
		axios.get("http://localhost:8081//displayAllDeposists", { headers: {
...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
			...
			<div style={{backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVr19m816je6tE6b8rusGLwjzq2bcVsUhprg&usqp=CAU')"}}></div>
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:430,width:650,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}}className={"border border-dark  text-white"}>
				<Card.Header 
className="text-white bg-dark"><h5>DEPOSIT LIST</h5></Card.Header>
				<Card.Body>
					<Table bordered hover striped variant="dark">
				    	<thead>
						    <tr>
						     
						      <th style={{textAlign:"center",width:"50%",marginBottom:"80%",justifyContent:"center"}}> Account </th>
                              <th style={{textAlign:"center"}}>Amount Deposited to self</th>
					  	...
					  	<tbody>
						  {
						  	...
						  	<tr align="center">
						    	<td colSpan="6">No Deposits as of Now.</td>
						    </tr> : 
