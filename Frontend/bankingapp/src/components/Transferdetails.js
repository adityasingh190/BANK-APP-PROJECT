...
export default class Transferdetails extends Component {
	...
	componentDidMount(){
		axios.get("http://localhost:8081//displayAllTransfers", { headers: {
...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
			...
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:310,width:950,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}}
className={"border border-dark  text-white"}>
				<Card.Header className="text-white bg-dark"><h5>TRANSFER LIST</h5></Card.Header>
				<Card.Body>
					<Table bordered hover striped variant="dark">
				    	<thead>
						    <tr>
						     
						      <th style={{textAlign:"center",width:"50%",justifyContent:"center"}}>Source Account </th>
                              <th style={{textAlign:"center",width:"50%",justifyContent:"center"}}>Amount transferred</th>
                              <th style={{textAlign:"center",width:"50%",justifyContent:"center"}}>Destination Account </th>
						    </tr>
					  	</thead>
					  	<tbody>
						  {
						    ...
						    <tr key={user._id}>
					    		<td style={{textAlign:"center",width:35}}>{user.source_accNo}</td>
					    		<td style={{textAlign:"center",width:35}}>{user.amt_to_trans}</td>
                                <td style={{textAlign:"center",width:35}}>{user.dest_accNo}</td>
