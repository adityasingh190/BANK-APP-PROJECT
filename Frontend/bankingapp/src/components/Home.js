...
import pot from "../images/top.jpg";
...
function Home(){
    ...
    return (<div id="dashboard" className="bg-dark">

<div className="bg-dark">

</div>
        <div id="top-image" >
            <img width="10"height="300" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR6hsbJgnlc8KWhBZwcCc7DinTjUXAmxcPMhQ&usqp=CAU" alt="top" />
        </div>

        <div id="card-wrapper" style={{height:600}}>
            <div className="card" style={{height:200}}>
            <i style={{marginTop:0,height:3}}class="fas fa-university"></i>
                <div className="card-right"style={{marginTop:20}}  >
                    <img width="290" height="180"src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkN4we4eB84VlGhwXArr-WVTPPwB2wTBVXKw&usqp=CAU"/>
            ...
            <i class="fas fa-piggy-bank"></i>
                <div className="card-right">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQaSgh6yS3O46KoznCSD-4VVSPyKo8EH2_CvA&usqp=CAU"/>
            ...
            <i class="fas fa-shield-alt"></i>
                <div className="card-right">
                    <img height="200"width="290"src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpydfGrKUiXNCJThdMc1KiQsxlo6vzciPTvQ&usqp=CAU"/>
