...
export default class Update extends Component {
	...
	constructor(props){
		super(props);
		this.state={accNo:'', custName:'',customerId:'', IFSC_code:'',password:'',accNo1:'',balance:'',};
 ...
 if(!(/[A-Z|a-z]{4}[0][a-zA-Z0-9]{6}$/.test(this.state.IFSC_code)))
 {
	alert("IFSC Code is invalid");
 }
 if(this.state.balance<2500)
 {
	alert("Please enter the balance greater than 2500");
 }
 else{
		axios.put("http://localhost:8081//Update", {}, {params:update}, { headers: {
...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
				  <h2 style={{color:"black",marginLeft:560}} >
...
<div style={{backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVr19m816je6tE6b8rusGLwjzq2bcVsUhprg&usqp=CAU')"}}>
			...
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:450,width:650,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}}className={"border border-dark bg-dark text-white"}>
				<Card.Header style={{marginLeft:25}} className='bg-dark text-white'>Enter required details</Card.Header>
					<Form onSubmit={this.submitupdate} id="depositFormId" style={{alignItems:"center",justifyContent:"center"}}>
						<Card.Body style={{alignItems:"center",justifyContent:"center"}}>
							  <Form.Row style={{alignItems:"center",justifyContent:"center"}}>
							  	<Form.Group as={Col} controlId="formGridTitle"style={{alignItems:"center",justifyContent:"center"}}>
							  	  <Form.Label style={{marginLeft:43}}className='text-dark'>Old Account number</Form.Label>
							  	  <Form.Control required
							  	  	...
							  	  	placeholder="Enter Account number" />
                                      	  <Form.Label style={{marginLeft:43}}className='text-dark'>New Account number</Form.Label>
							  	  <Form.Control required
							  	  ...
							  	  <Form.Label style={{marginLeft:63}}className='text-dark'>Customer Name</Form.Label>
							  	  <Form.Control required
                                     ...
                                     <Form.Label style={{marginLeft:83}}className='text-dark'>Customer Id</Form.Label>
							  	  <Form.Control required
                                     ...
                                     <Form.Label style={{marginLeft:90}} className='text-dark'>IFSC Code</Form.Label>
							  	  <Form.Control required
...
<Form.Label style={{marginLeft:100}} className='text-dark'>Balance</Form.Label>
							  	  <Form.Control required
...
<Form.Label style={{marginLeft:100}} className='text-dark'>Password</Form.Label>
                                   <Form.Control required
