...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
			...
			<div >
			<div >
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:450,width:650,backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')",backgroundSize:"cover"}} className={"border border-dark  text-white"}>
