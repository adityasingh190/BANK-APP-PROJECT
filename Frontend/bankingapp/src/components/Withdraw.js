...
export default class Withdraw extends Component {
	...
	constructor(props){
		super(props);
		this.state={accNo:'', withraw_amount:''};
	...
	submitWithdraw(event) {
		...
		const withdraw = {
			...
			withraw_amount: this.state.withraw_amount
		};

		axios.put("http://localhost:8081//withraw", {}, {params: withdraw}, { headers: {
...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
				  <h2 style={{color:"black",marginLeft:530,marginTop:20}} >
...
<div style={{backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVr19m816je6tE6b8rusGLwjzq2bcVsUhprg&usqp=CAU')"}}>
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:450,width:650,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}} className={"border border-dark  text-white"}>
				<Card.Header style={{marginLeft:24}} className="text-white bg-dark">Enter the details</Card.Header>
					<Form onSubmit={this.submitWithdraw} id="depositFormId" style={{alignItems:"center",justifyContent:"center"}}>
						<Card.Body style={{alignItems:"center",justifyContent:"center"}}>
							  <Form.Row>
							  	<Form.Group as={Col} controlId="formGridTitle">
							  	  <Form.Label style={{marginLeft:90}} className="text-dark">Account Id</Form.Label>
							  	  ...
							  	  <Form.Label style={{marginLeft:100}}className="text-dark">Amount</Form.Label>
							  	  <Form.Control required
							  	  	type="number" name="withraw_amount"
							  	  	value={this.state.withraw_amount}
							  	  	onChange={this.withdrawChange}
							  	  	className={"bg-dark text-white"}
						...
						<Card.Footer style={{"textAlign":"right"}} >
							<Button style={{marginRight:20}} size="sm" variant="success" type="submit">
							  Submit
							</Button>
						</Card.Footer>
					</Form>
