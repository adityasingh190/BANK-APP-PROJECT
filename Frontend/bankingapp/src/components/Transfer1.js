...
export default function Transfer1 (props) {
...
console.log(location);
		...
		axios.put("http://localhost:8081//transfer", {}, {params: transfer}, { headers: {
...
style={{color:"rgb(176,0,0)",marginLeft:440,display:"table",backgroundColor:"black"}} > WELCOME TO BANKING</h1>
				  <h2 style={{color:"black",marginLeft:540}} >
				  TRANSFER FORM
				  </h2>
				  </div>
			</Jumbotron>
			...
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:410,width:650,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}} className={"border border-dark  text-white"}>
					...
					<Form onSubmit={submitDeposit} id="depositFormId">
						<Card.Body>
							  <Form.Row>
								  ...
								  ><strong>Destination Account Number</strong></Form.Label>
							  	  ...
							  	  <Form.Control required
							  	  	...
							  	  	onChange={event=>settransfer_amount(event.target.value)}
							  	  	className={"bg-dark text-white"}
