...
export default class Transfer extends Component {
	...
	constructor(props){
		super(props);
		this.state={accNo:'',accNo1:'', transfer_amount:''};
	...
	submittransfer(event) {
		...
		axios.put("http://localhost:8081/transfer" ,{}, {params:transfer}
		// { headers: {
...
<div style={{backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVr19m816je6tE6b8rusGLwjzq2bcVsUhprg&usqp=CAU')"}}>
			...
			<Card style={{alignItems:"center",justifyContent:"center",marginLeft:450,width:650,backgroundSize:"cover",backgroundImage:"url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbdUmlrAvwDMX2KFXEq6QKnBd-r5BRaFK5bQ&usqp=CAU')"}}

className={"border border-dark  text-white"}>
				<Card.Header style={{marginLeft:50}} className="text-white bg-dark">Enter Required Details</Card.Header>
					<Form onSubmit={this.submittransfer} id="depositFormId" style={{alignItems:"center",justifyContent:"center"}}>
						<Card.Body>
							  <Form.Row style={{alignItems:"center",justifyContent:"center"}}>
							  	<Form.Group as={Col} controlId="formGridTitle" style={{alignItems:"center",justifyContent:"center"}}>
							  	  <Form.Label style={{color:"black",marginLeft:120}} className="text-dark">Source Account Number</Form.Label>
							  	  <Form.Control required style={{width:400,marginLeft:50}}
							  	  	type="text" name="accNo"
							  	  	value={this.state.accNo}
							  	  	onChange={this.transferChange}
							  	  	className={"bg-dark text-white"}
							  	  	placeholder="Enter Source Account Number" />
                                     <Form.Label style={{color:"black",marginLeft:120}}className="text-dark">Destination Account Number</Form.Label>
							  	  <Form.Control required style={{width:400,marginLeft:50}}
							  	  ...
							  	  <Form.Label style={{color:"black",marginLeft:190}} className="text-dark">Amount</Form.Label>
							  	  <Form.Control required style={{width:400,marginLeft:50}}
							  	  	type="number" name="transfer_amount"
